...
flags.DEFINE_float("learning_rate_g", 0.0041, "Learning rate of for adam [0.0002]")
flags.DEFINE_float("learning_rate_v", 0.0041, "Learning rate of for adam [0.0002]")
flags.DEFINE_float("learning_rate_d", 0.0041, "Learning rate of for adam [0.0002]")
