...
flags.DEFINE_float("learning_rate_g", 0.002, "Learning rate of for adam [0.0002]")
flags.DEFINE_float("learning_rate_v", 0.002, "Learning rate of for adam [0.0002]")
flags.DEFINE_float("learning_rate_d", 0.002, "Learning rate of for adam [0.0002]")
flags.DEFINE_float("save_every", 300, "How often to save")
